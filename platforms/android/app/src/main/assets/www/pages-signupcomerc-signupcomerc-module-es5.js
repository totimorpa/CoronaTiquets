...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-signupcomerc-signupcomerc-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesSignupcomercSignupcomercPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesSignupcomercSignupcomercRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SignupcomercPageRoutingModule", function () {
      return SignupcomercPageRoutingModule;
    });
    /* harmony import */
    ...
    var _signupcomerc_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./signupcomerc.page */
    ...
    var SignupcomercPageRoutingModule = function SignupcomercPageRoutingModule() {
      _classCallCheck(this, SignupcomercPageRoutingModule);
    };

    SignupcomercPageRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppPagesSignupcomercSignupcomercModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SignupcomercPageModule", function () {
      return SignupcomercPageModule;
    });
    /* harmony import */
    ...
    var _signupcomerc_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./signupcomerc-routing.module */
    "./src/app/pages/signupcomerc/signupcomerc-routing.module.ts");
    /* harmony import */


    var _signupcomerc_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./signupcomerc.page */
    "./src/app/pages/signupcomerc/signupcomerc.page.ts");

    var SignupcomercPageModule = function SignupcomercPageModule() {
      _classCallCheck(this, SignupcomercPageModule);
    };

    SignupcomercPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _signupcomerc_routing_module__WEBPACK_IMPORTED_MODULE_5__["SignupcomercPageRoutingModule"]],
  ...
  /***/
  function srcAppPagesSignupcomercSignupcomercPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesSignupcomercSignupcomercPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SignupcomercPage", function () {
      return SignupcomercPage;
    });
    /* harmony import */
    ...
    var SignupcomercPage =
    /*#__PURE__*/
    function () {
      function SignupcomercPage(router, http) {
        _classCallCheck(this, SignupcomercPage);

        this.router = router;
        this.http = http;
      }

      _createClass(SignupcomercPage, [{
        key: "submitForm",
        value: function submitForm(formData) {
          console.log(formData);
          this.http.post("", formData).subscribe(function (res) {
            console.log(res);
          });
        }
      }, {
    ...
    SignupcomercPage.ctorParameters = function () {
      return [{
    ...
    SignupcomercPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-signupcomerc',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./signupcomerc.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/signupcomerc/signupcomerc.page.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./signupcomerc.page.scss */
      "./src/app/pages/signupcomerc/signupcomerc.page.scss")).default]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"]])], SignupcomercPage);
    /***/
  }
}]);
//# sourceMappingURL=pages-signupcomerc-signupcomerc-module-es5.js.map